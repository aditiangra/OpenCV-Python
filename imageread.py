...
img1 = cv2.imread('C:\\Users\\Aditi Angra\\Desktop\\New folder\\powerpuff.jpg',1)  
...
img2 = cv2.imread('C:\\Users\\Aditi Angra\\Desktop\\New folder\\powerpuff.jpg',0)
img2 = cv2.resize(img2,(1280,700))#width ,height
cv2.imshow("Gray Scale Image",img2)
print("Image in gray scale==\n",img2)

#cv2.IMREAD_UNCHANGED : Loads image as such including alpha channel
img3 = cv2.imread('C:\\Users\\Aditi Angra\\Desktop\\New folder\\powerpuff.jpg',-1)
...
#Now read image 
img1 = cv2.imread("C:\\Users\\Aditi Angra\\Desktop\\New folder\\powerpuff.jpg",0) #convert image into grayscale
